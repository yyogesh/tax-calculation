(function () {
    ...
    taxForm.addEventListener('submit', function (e) {
        ...
        simulateProcessing(taxableIncome, age)
                .then(({totalTax, taxBreakdown}) => {
                    hideLoader();
                    const effectiveTaxRate = (totalTax / income) * 100;
                    displayResults(taxableIncome, totalTax, effectiveTaxRate, taxBreakdown, income, standardDeduction + otherDeductions);
                })
                .catch(error => {
                    hideLoader();
    ...
    function displayResults(taxableIncome, totalTax, effectiveTaxRate, taxBreakdown, income, deductions) {
        ...
        //updateCharts(income, deductions, tax, slabWiseTax);
